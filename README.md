...
## 🚀 적용 방법
* [1.4 버전 가이드 보기](./1.4/README_4.md)
* [1.5 버전 가이드 보기](./1.5/README_5.md)
...
>
> - **Attribution (저작자 표시):**
>   - 본 가이드나 수정된 스크립트를 **재배포(공유)하거나 자신의 게임에 사용**할 경우, 원저작자(**Runga3203 & AED_PYMOOD1**)를 명시해야 합니다. 
>
